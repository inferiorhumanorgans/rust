...
fn main() {
    ...
    for flag in cxxflags.split_whitespace() {
        ...
        // In theory our compilers should know which C++ libraries they're compatible with, so
        // this could warrant a noisy warning.  However in the libc++ host to dragonfly target
        // case, we really don't want to override the compiler.
